...
class predictor():
    def __init__(self,device):
        ...
        self.similarity_model.load_state_dict(torch.load("saved_models/siamese_multi_head_93.022",map_location=self.device))
        ...
        self.model_label_classifier.load_state_dict(torch.load(f'saved_models/faster_rcnn_sgd_0.01'))
