...
### 3. Website :
Note : In the website the format the model returns is that of the FUND dataset, for MTX evaluation purposes go to [batch_run](https://github.com/FrozenWolf-Cyber/OCR/tree/master/batch_run) where you can choose the output format.Annotation works only in Firefox
#### Hosting in azure VM
